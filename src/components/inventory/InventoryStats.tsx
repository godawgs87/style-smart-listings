...
const InventoryStats = ({ totalItems, totalValue, averageProfit, averageDaysToSell }: InventoryStatsProps) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{averageDaysToSell.toFixed(0)} days</div>
        </CardContent>
      </Card>
    </div>
  );
