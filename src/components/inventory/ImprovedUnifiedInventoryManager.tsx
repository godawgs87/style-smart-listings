...
interface ImprovedUnifiedInventoryManagerProps {
  onCreateListing: () => void;
  onBack: () => void;
}

const ImprovedUnifiedInventoryManager = ({ onCreateListing, onBack }: ImprovedUnifiedInventoryManagerProps) => {
  ...
  const { listings, loading, error, stats, refetch } = useRobustInventory({
...
export default ImprovedUnifiedInventoryManager;
